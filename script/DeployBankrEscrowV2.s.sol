...
/// @title DeployBankrEscrowV2
/// @notice Deploys the V2 fee-rights escrow with optional initial fee-manager allowlist entries.
/// @dev Use Foundry CLI flags for simulation/broadcast:
///      forge script script/DeployBankrEscrowV2.s.sol --rpc-url $BASE_SEPOLIA_RPC_URL
///      forge script script/DeployBankrEscrowV2.s.sol --rpc-url $BASE_SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --broadcast
contract DeployBankrEscrowV2 is Script {
    ...
    function run() external returns (BankrEscrowV2 escrow) {
        ...
        console2.log("Deploying BankrEscrowV2");
        console2.log("Deployer:", deployer);
        console2.log("Initial owner:", initialOwner);

        vm.startBroadcast(deployerPrivateKey);

        escrow = new BankrEscrowV2(initialOwner);
        ...
        console2.log("BankrEscrowV2 deployed:", address(escrow));
    }
